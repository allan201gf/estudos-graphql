...
public interface CompraRepository extends JpaRepository<Compra, Long> {
    ...
    @Query("select new br.com.allangf.compras.graphql.dto.CompraResumo(c.id,cli.nome,p.nome,c.quantidade) from Compra c inner join c.cliente cli inner join c.produto p")
